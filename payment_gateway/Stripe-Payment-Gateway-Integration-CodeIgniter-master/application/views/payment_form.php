...
<head>
    ...
    <script type="text/javascript">
        ...
        Stripe.setPublishableKey('pk_test_51JC6x5GmKnguJE09odlgJKYQDYA0qtN4TcPyzWIDK4iNovINdRRQtgMM1dL3tRTu9uEvCV4ItmJn3CfFqLCFtghE00doEzT4QV');
...
<h1><center>Stripe payment gateway integration in codeigniter(transfer)</center></h1>
            ...
            <div class="card">
                ...
                <div class="card-body bg-light">
                    ...
                    <div id="payment-errors"></div>  
                     <form method="post" id="paymentFrm" enctype="multipart/form-data" action="<?php echo base_url(); ?>Transfer/payment">
